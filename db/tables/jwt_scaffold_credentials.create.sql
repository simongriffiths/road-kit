...
-- ORA-955-tolerant, matching this table's own drop.sql -- see road-atlas F-10. The comment on
-- statements below stay outside the wrap: they are already idempotent on their own.
begin
  execute immediate q'[
